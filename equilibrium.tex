...
\end{prop}
    ...
    The generator quantifies the rate of change of a property $\varphi$ under the evolution of the system. If we define, for $t\geq 0$, the evolution operators 
...
\paragraph{The Metropolis-Hastings algorithm}
